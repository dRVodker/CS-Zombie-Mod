void OverrideLimits()
{
	...
	RoundManager.Limit_Random("item_armor", 4);

	RoundManager.Limit_Random("item_healthkit", 2);				//Replaced with the Antidote
	RoundManager.Limit_Random("item_pills", 4);					//Replaced with the Adrenaline
	...
	RoundManager.Limit_Random("weapon_machete", 10);			//Replaced with the FragMine
	...
	RoundManager.Limit_Random("weapon_winchester", 2);

	RoundManager.Limit_Random("weapon_revolver", 3);

	RoundManager.Limit_Random("weapon_barricade", 8);
	RoundManager.Limit_Random("item_ammo_barricade", 12);
