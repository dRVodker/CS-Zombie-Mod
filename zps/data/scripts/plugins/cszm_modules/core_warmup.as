void WarmUpTimer()
{
	...
	else if (iNumPlrs <= 1)
	{
		...
		SendGameText(any, TEXT_AMP, 0, 0, -1, 0, 0, 0, 600, Color(255, 255, 255), Color(255, 95, 5));
	}
}
...
void WarmUpEnd()
{
	...
	SendGameText(any, TEXT_HintF1, 5, 0, 0.05f, 0.1f, 0, 2.0f, 120, Color(64, 128, 255), Color(255, 95, 5));
	SendGameText(any, "\n" + TEXT_HintF3, 4, 0, 0.05f, 0.1f, 0, 2.0f, 120, Color(255, 255, 255), Color(255, 95, 5));
