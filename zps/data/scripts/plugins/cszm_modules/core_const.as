...
const float CONST_SLOWDOWN_TIME = 0.1425f;		//Время замедления, которое получает зомби от любого урона
const float CONST_RECOVER_TIME = 0.12f;			//Время, которое должно пройти, чтобы добавить "CONST_RECOVER_SPEED" к скорости зомби
