...
const float CONST_RECOVER_UNIT = 0.1f;	//Speed recovery tick time
const int CONST_RECOVER_SPEED = 4;	//Amout of speed to recover per tick
...
const int CONST_WEAK_ZOMBIE_HP = 195;	//Health of the weak zombies
