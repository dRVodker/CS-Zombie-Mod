...
int iZombieHealth = 375;			//HP зомби
...
float flInfectedExtraHP = 0.30f;	//Процент дополнительного HP для первых зараженных, от HP обычных зомби (от iZombieHealth)
float flInfectionPercent = 0.3f;	//Процент выживших, которые будут заражены в начале раунда
float flPSpeed = 0.22f;				//Процент скорости, которая останется у игрока после замедления
...
float flPropHPPercent = 0.115f;		//Часть от текущего HP, которая будет умножена на количество игроков для получения итогового HP
