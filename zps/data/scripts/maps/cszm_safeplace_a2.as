...
{
	{
		CSpawnPoint(Vector(1415.28, 2173.56, 128.031), QAngle(-1.30669, 179.261, 0), "info_player_zombie"),
		CSpawnPoint(Vector(-768.316, 3094.15, 128.031), QAngle(-0.435487, -88.6094, 0), "info_player_zombie")
	}
};
...
void SetUpStuff()
{
	...
	CreateSpawnsFromArray(SP_ZombieSpawns);
}
